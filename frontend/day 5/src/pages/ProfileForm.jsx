...
const ProfileForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>
        Password (at least 8 characters with a combination of uppercase letters, lowercase letters, numbers, and symbols):
        <input type="password" name="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,}$" value={formData.password} onChange={handleChange} required />
      </label>
